      ...
      <div className="content">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-1 lg:order-1">
            <img
              src="/Home/fueldayImage.png"
              alt="Roseate Farms Premium Almonds Package"
          ...
          <div className="order-1 lg:order-2">
            {/* Mobile: 2x2 Grid */}
            <div className="grid grid-cols-1 gap-2 md:gap-3 lg:hidden">
            ...
            <div className="hidden lg:grid grid-cols-3 gap-3 auto-rows-[minmax(100px,auto)]">
              {benefits.map((benefit, index) => (
                <div
                  key={index}
